 ...
 *          - Maintain an explicit shell command and variable registry
                                   ...
                                   shell_core_list_iterator_t *p_iterator)
{
    ...
    return p_list->p_first(p_list->p_context, &p_iterator->p_cursor);
}
...
static void shell_handle_param(shell_core_item_t *p, char c, char *line, shell_core_io_t *my_printf)
{
    ...
    else
    {
        ...
        shell_core_item_print(p, my_printf);
...
void shell_core_run(const shell_core_list_t *p_list, uint8_t data, shell_core_io_t *my_printf, void *p_ctx)
{
    ...
    while (p_item != NULL)
    {
        ...
        shell_handle_param(p_item, c, line, my_printf);
        goto shell_done;
    }
