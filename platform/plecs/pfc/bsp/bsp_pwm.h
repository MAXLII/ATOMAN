...
/**
 * @file    bsp_pwm.h
 * @brief   PLECS PFC PWM adapter interface module.
 * @details
 *          This file is part of the base project.
 *
 *          Module responsibilities:
 *          - Declare simulated PWM enable and disable functions
 *          - Declare bridge duty update function used by the PFC HAL
...
#ifndef PLECS_PFC_BSP_PWM_H
#define PLECS_PFC_BSP_PWM_H
