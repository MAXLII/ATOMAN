...
#ifndef __APM32F402_403_ADC_H
#define __APM32F402_403_ADC_H
...
#define REGSEQC_SET_REGSEQ1 ((uint32_t)0x0000001F)
    ...
    typedef enum
    {
        ...
        ADC_EXT_TRIG_CONV_EINT11    = ((uint32_t)0x000C0000),
    ...
    typedef enum
    {
        ...
        ADC_EXT_TRIG_INJEC_CONV_EINT15    = ((uint8_t)0x06),
    ...
    typedef struct
    {
        ...
        uint8_t continuousConvMode; /*!< This parameter can be ENABLE or DISABLE. */
    ...
    void ADC_ConfigInjectedChannel(ADC_T *adc,
                                   uint8_t channel,
                                   uint8_t rank,
                                   uint8_t sampleTime);
