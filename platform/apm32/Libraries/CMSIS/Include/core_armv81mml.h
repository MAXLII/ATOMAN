...
#define __ARMv81MML_CMSIS_VERSION      ((__ARMv81MML_CMSIS_VERSION_MAIN << 16U) | __ARMv81MML_CMSIS_VERSION_SUB) /*!< \deprecated CMSIS HAL version number */
...
#if ((defined(__ICACHE_PRESENT) && (__ICACHE_PRESENT == 1U)) || (defined(__DCACHE_PRESENT) && (__DCACHE_PRESENT == 1U)))
