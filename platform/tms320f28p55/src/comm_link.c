...
DECLARE_COMM_CTX(s_f28p55_scia_comm, F28P55_COMM_PAYLOAD_SIZE, HOST_ADDR, F28P55_SCIA_LINK);

static const section_link_handler_item_t s_f28p55_scia_handlers[] = {
    {.func = comm_run, .ctx = (void *)&s_f28p55_scia_comm},
};

REG_LINK(F28P55_SCIA_LINK, s_f28p55_scia_tx, tms320f28p55_uart_rx_get_byte, s_f28p55_scia_handlers,
