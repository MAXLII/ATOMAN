...
includeDirs = {
    ...
    fullfile(codeDir, 'section', 'baremetal')
    fullfile(codeDir, 'dbg')
...
mexArgs = [mexArgs, {'-DS_FUNCTION_NAME=sfunc', '-DPLATFORM_MATLAB', '-DIS_MATLAB', '-DIS_INV', toolchainArg, '-D__RAM_FUNC='}];
