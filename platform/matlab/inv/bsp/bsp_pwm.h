...
/**
 * @file    bsp_pwm.h
 * @brief   MATLAB inverter PWM adapter interface module.
 * @details
 ...
 *          - Keep MATLAB output updates behind the BSP PWM interface
 *
 *          Design notes:
 *          - C11 compatible
...
#ifndef MATLAB_INV_BSP_PWM_H
#define MATLAB_INV_BSP_PWM_H
