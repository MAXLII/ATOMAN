...
DECLARE_COMM_CTX(s_bootloader_comm, HC32_BOOTLOADER_RX_PAYLOAD_SIZE, HOST_ADDR, HC32_BOOTLOADER_LINK_ID);

static const section_link_handler_item_t s_handlers[] = {
    {.func = comm_run, .ctx = &s_bootloader_comm},
};

REG_LINK(HC32_BOOTLOADER_LINK_ID, s_bootloader_tx, hc32_boot_uart_rx_get_byte, s_handlers,
