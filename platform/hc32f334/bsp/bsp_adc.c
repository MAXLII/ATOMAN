...
const bsp_adc_param_t bsp_adc_param[ADC_TABLE_MAX] = {
    ...
    [VAUX] = {.adc_name    = VAUX,
              ...
              .pin         = GPIO_PIN_03,
              .sample_time = SAMPLE_TIME},
    [TEMP3] = {.adc_name    = TEMP3,
               .adc_periph  = CM_ADC3,
               .adc_ch      = ADC_CH6,
               .gpio_periph = GPIO_PORT_A,
               .pin         = GPIO_PIN_06,
               .sample_time = SAMPLE_TIME},
    [ACCVS] = {.adc_name    = ACCVS,
               .adc_periph  = CM_ADC3,
               .adc_ch      = ADC_CH8,
               .gpio_periph = GPIO_PORT_B,
               .pin         = GPIO_PIN_00,
               .sample_time = SAMPLE_TIME},
    [RMTVS] = {.adc_name    = RMTVS,
               .adc_periph  = CM_ADC3,
               .adc_ch      = ADC_CH9,
               .gpio_periph = GPIO_PORT_B,
               .pin         = GPIO_PIN_01,
               .sample_time = SAMPLE_TIME},
    [TEMP1] = {.adc_name    = TEMP1,
               .adc_periph  = CM_ADC3,
               .adc_ch      = ADC_CH10,
               .gpio_periph = GPIO_PORT_B,
               .pin         = GPIO_PIN_02,
               .sample_time = SAMPLE_TIME},
    [TEMP2] = {.adc_name    = TEMP2,
               .adc_periph  = CM_ADC3,
               .adc_ch      = ADC_CH11,
               .gpio_periph = GPIO_PORT_B,
               .pin         = GPIO_PIN_10,
