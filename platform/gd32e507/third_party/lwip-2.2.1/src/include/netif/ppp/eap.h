...
#define EAP_STATES \
    "Initial", "Pending", "Closed", "Listen", "Identify", "SRP1", "SRP2", "SRP3", "MD5Chall", "Open", "SRP4", "BadAuth"

#define eap_client_active(pcb) ((pcb)->eap.es_client.ea_state == eapListen)
#if PPP_SERVER
#define eap_server_active(pcb) \
    ((pcb)->eap.es_server.ea_state >= eapIdentify && (pcb)->eap.es_server.ea_state <= eapMD5Chall)
#endif /* PPP_SERVER */
