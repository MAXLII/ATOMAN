 ...
 * @brief   Zynq-7020 bare-metal section platform configuration.
 * @details
 *          This file is part of the Zynq-7020 platform project.
 *
 *          Module responsibilities:
 *          - Select the generic section runtime for the bare-metal project
 ...
 *          - Selected through the bare-metal project include path
 *
 * @author  Max.Li
 * @date    2026-07-17
 * @version 1.0.0
