...
```text
code/app/bootloader/bootloader_core.c
code/app/bootloader/bootloader_core.h
```
...
```text
code/app/bootloader/bootloader_metadata.c
code/app/bootloader/bootloader_metadata.h
```
...
```text
code/app/bootloader/bootloader_protocol.c
code/app/bootloader/bootloader_protocol.h
code/comm/comm.c
```
...
```text
code/app/bootloader/iap_update_service.c
code/app/bootloader/iap_update_service.h
```
