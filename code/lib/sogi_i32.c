                     ...
                     uint8_t coeff_q_shift)
{
    ...
    p_sogi->inter.b[0] = sogi_i32_float_to_i32((n0 / d0) * coeff_q * (float)SOGI_I32_NUM_GAIN);
    p_sogi->inter.b[1] = 0;
    p_sogi->inter.b[2] = sogi_i32_float_to_i32((n2 / d0) * coeff_q * (float)SOGI_I32_NUM_GAIN);
    ...
    p_sogi->inter.qb[0] = sogi_i32_float_to_i32((n0 / d0) * coeff_q * (float)SOGI_I32_NUM_GAIN);
    p_sogi->inter.qb[1] = sogi_i32_float_to_i32((n1 / d0) * coeff_q * (float)SOGI_I32_NUM_GAIN);
    p_sogi->inter.qb[2] = sogi_i32_float_to_i32((n2 / d0) * coeff_q * (float)SOGI_I32_NUM_GAIN);
...
bool sogi_i32_cal(sogi_i32_t *p_sogi)
{
    ...
    p_sogi->inter.err   = sogi_i32_sat_i64_to_i32((int64_t)p_sogi->inter.x[0] - (int64_t)p_sogi->output.u);
