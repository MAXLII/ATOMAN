...
void dsogi_reset(dsogi_t *p_dsogi)
{
    ...
    {
        sogi_init(&p_dsogi->inter.alpha,
                  p_dsogi->cfg.ts,
                  p_dsogi->cfg.omega_min,
                  p_dsogi->cfg.k,
                  p_dsogi->input.p_alpha);
        sogi_init(&p_dsogi->inter.beta, p_dsogi->cfg.ts, p_dsogi->cfg.omega_min, p_dsogi->cfg.k, p_dsogi->input.p_beta);
    }
}
