...
/**
 * @file    shell.c
 * @brief   shell communication module.
 * @details
 *          This file is part of the digital power framework project.
 *
 *          Module responsibilities:
 *          - Parse text shell input into command names, arguments, and variable operations
 *          - Dispatch registered shell commands and read/write registered shell variables with type conversion
 *          - Provide auto-report support and bridge shell output through the caller-provided transport
 *
 *          Design notes:
 *          - C11 compatible
