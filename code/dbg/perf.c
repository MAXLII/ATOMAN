 ...
 *          - Discover SECTION_PERF registrations and build the record list
 ...
 *          - Linker-section and system-tick access are isolated to this file
...
static void perf_init(void)
{
    ...
    perf_core_init(&perf_list, p_perf_base, SECTION_SYS_TICK, SECTION_SYS_TICK_UNIT_US);
}
...
{
    return perf_core_base_is_ready();
}
float perf_count_period_s_get(void)
{
    return perf_core_count_period_s_get();
}
float perf_count_unit_us_get(void)
{
    return perf_core_count_unit_us_get();
}
uint32_t perf_count_unit_ns_get(void)
{
    return perf_core_count_unit_ns_get();
}
uint32_t perf_cnt_per_sys_tick_get(void)
{
    return perf_core_cnt_per_sys_tick_get();
}
float perf_task_metric_get(void)
{
    return perf_core_task_metric_get();
}
float perf_task_metric_max_get(void)
{
    return perf_core_task_metric_max_get();
}
float perf_interrupt_metric_get(void)
{
    return perf_core_interrupt_metric_get();
}
float perf_interrupt_metric_max_get(void)
{
    return perf_core_interrupt_metric_max_get();
}
uint32_t perf_dict_version_get(void)
{
    return perf_core_dict_version_get();
}
uint16_t perf_record_count_get(void)
{
    return perf_core_record_count_get(&perf_list);
}
...
{
    return perf_core_count_to_us(count);
}
uint32_t perf_count_to_100ns(uint32_t count)
{
    return perf_core_count_to_100ns(count);
}
...
{
    perf_core_reset_peak_value(&perf_list);
}
