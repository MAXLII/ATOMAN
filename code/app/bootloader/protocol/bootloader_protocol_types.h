...
_Static_assert(sizeof(bootloader_protocol_version_t) == 4u, "FRAME upgrade version payload must be 4 bytes");
_Static_assert(sizeof(bootloader_protocol_reject_reason_t) == 2u, "FRAME upgrade rejection reason must be 2 bytes");
...
_Static_assert(sizeof(bootloader_protocol_info_ack_t) == 3u, "FRAME command 0x08 ACK payload must be 3 bytes");
...
_Static_assert(sizeof(bootloader_protocol_ready_ack_t) == 1u, "FRAME command 0x09 ACK payload must be 1 byte");
...
_Static_assert(sizeof(bootloader_protocol_data_ack_payload_t) == 1u, "FRAME command 0x0A ACK payload must be 1 byte");
_Static_assert(sizeof(bootloader_protocol_end_request_t) == 2u, "FRAME command 0x0B request payload must be 2 bytes");
_Static_assert(sizeof(bootloader_protocol_end_ack_payload_t) == 1u, "FRAME command 0x0B ACK payload must be 1 byte");
