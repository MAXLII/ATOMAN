 ...
 */
static inline uint16_t bootloader_update_request_checksum_calculate(const bootloader_protocol_info_request_t *p_info)
{
...
_Static_assert(sizeof(bootloader_update_request_t) == 16u, "Retained IAP-to-Bootloader request must be 16 bytes");
