...
/**
 * @file    boost_ctrl.h
 * @brief   boost_ctrl control public interface.
 * @details
 *          This file is part of the digital power framework project.
 *
 *          Module responsibilities:
 *          - Declare BOOST controller public runtime hooks
 *          - Expose controller preparation before entering run state
 *          - Provide the interface shared by BOOST configuration, HAL binding, and runtime control
 *
 *          Design notes:
 *          - C11 compatible
