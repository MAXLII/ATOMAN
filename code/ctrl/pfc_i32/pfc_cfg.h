...
#define PFC_CTRL_AC_VOLT_CODE_PER_V ((float)PFC_CTRL_AC_VOLT_CODE_MAX / PFC_CTRL_AC_VOLT_MAX_V)
...
#define PFC_CTRL_BUS_VOLT_CODE_PER_V ((float)PFC_CTRL_BUS_VOLT_CODE_MAX / PFC_CTRL_BUS_VOLT_MAX_V)

#define PFC_CTRL_PWM_AC_TO_BUS_K_NUM ((int64_t)PFC_CTRL_BUS_VOLT_CODE_MAX * (int64_t)PFC_CTRL_AC_VOLT_MAX_V_INT)
#define PFC_CTRL_PWM_AC_TO_BUS_K_DEN ((int64_t)PFC_CTRL_AC_VOLT_CODE_MAX * (int64_t)PFC_CTRL_BUS_VOLT_MAX_V_INT)
...
#define PFC_CTRL_K1_VBUS_PI_GAIN_K \
    (((float)PFC_CTRL_IND_CURR_CODE_MAX / PFC_CTRL_IND_CURR_MAX_A) / PFC_CTRL_BUS_VOLT_CODE_PER_V)

/* K3 maps current-code error to PWM-reload-scaled AC-voltage command. */
#define PFC_CTRL_K3_CURR_PI_GAIN_K                                                                 \
    ((PFC_CTRL_AC_VOLT_CODE_PER_V / ((float)PFC_CTRL_IND_CURR_CODE_MAX / PFC_CTRL_IND_CURR_MAX_A)) \
     * (float)PFC_CTRL_PWM_CMP_MAX)

#define PFC_CTRL_VBUS_REF_TO_CODE(val) \
    ((int32_t)(((val) / PFC_CTRL_BUS_VOLT_MAX_V) * (float)PFC_CTRL_BUS_VOLT_CODE_MAX + 0.5f))
...
#define PFC_CTRL_PWM_PERIOD_COUNTS       ((PFC_CTRL_PWM_CLK_HZ * PFC_CTRL_PWM_HR_MUL) / PFC_CTRL_PWM_FREQ_HZ)
#define PFC_CTRL_PWM_UP_DOWN_HALF_CYCLES (2LL)
#define PFC_CTRL_PWM_RELOAD              ((int32_t)(PFC_CTRL_PWM_PERIOD_COUNTS / PFC_CTRL_PWM_UP_DOWN_HALF_CYCLES))
...
#define PFC_CTRL_GRID_RMS_NOMINAL_CODE ((int32_t)(PFC_CTRL_GRID_RMS_NOMINAL_V * PFC_CTRL_AC_VOLT_CODE_PER_V + 0.5f))
...
#define PFC_CTRL_VOLT_LOOP_KP \
    (sinf(PFC_CTRL_VOLT_LOOP_PM) * PFC_CTRL_VOLT_LOOP_WCUT * PFC_CTRL_VOLT_LOOP_OBJ * (float)PFC_CTRL_K1_VBUS_PI_GAIN_K)
#define PFC_CTRL_VOLT_LOOP_KI                                                                                  \
    ((sinf(PFC_CTRL_VOLT_LOOP_PM) * PFC_CTRL_VOLT_LOOP_WCUT * PFC_CTRL_VOLT_LOOP_OBJ * PFC_CTRL_VOLT_LOOP_WCUT \
...
#define PFC_CTRL_VBUS_LOOP_OUT_MAX_RAW \
    ((int32_t)((PFC_CTRL_VBUS_LOOP_OUT_MAX_A / PFC_CTRL_IND_CURR_MAX_A) * (float)PFC_CTRL_IND_CURR_CODE_MAX + 0.5f))
#define PFC_CTRL_VBUS_LOOP_OUT_MIN_RAW \
    ((int32_t)((PFC_CTRL_VBUS_LOOP_OUT_MIN_A / PFC_CTRL_IND_CURR_MAX_A) * (float)PFC_CTRL_IND_CURR_CODE_MAX - 0.5f))
...
#define PFC_CTRL_CURR_LOOP_KP \
    (sinf(PFC_CTRL_CURR_LOOP_PM) * PFC_CTRL_CURR_LOOP_WCUT * PFC_CTRL_CURR_LOOP_OBJ * (float)PFC_CTRL_K3_CURR_PI_GAIN_K)
#define PFC_CTRL_CURR_LOOP_KI                                                                                  \
    ((sinf(PFC_CTRL_CURR_LOOP_PM) * PFC_CTRL_CURR_LOOP_WCUT * PFC_CTRL_CURR_LOOP_OBJ * PFC_CTRL_CURR_LOOP_WCUT \
...
#define PFC_CTRL_CURR_LOOP_OUT_MAX_RAW \
    ((int32_t)((PFC_CTRL_CURR_LOOP_OUT_MAX_V / PFC_CTRL_AC_VOLT_MAX_V) * (float)PFC_CTRL_AC_VOLT_CODE_MAX + 0.5f))
#define PFC_CTRL_CURR_LOOP_OUT_MIN_RAW \
    ((int32_t)((PFC_CTRL_CURR_LOOP_OUT_MIN_V / PFC_CTRL_AC_VOLT_MAX_V) * (float)PFC_CTRL_AC_VOLT_CODE_MAX - 0.5f))
#define PFC_CTRL_CURR_LOOP_OUT_MAX ((int32_t)((int64_t)PFC_CTRL_CURR_LOOP_OUT_MAX_RAW * (int64_t)PFC_CTRL_PWM_CMP_MAX))
#define PFC_CTRL_CURR_LOOP_OUT_MIN ((int32_t)((int64_t)PFC_CTRL_CURR_LOOP_OUT_MIN_RAW * (int64_t)PFC_CTRL_PWM_CMP_MAX))
