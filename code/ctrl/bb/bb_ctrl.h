...
#define BB_CTRL_OUT_VOLT_LOOP_KP \
    (sinf(BB_CTRL_OUT_VOLT_LOOP_PM * M_PI / 180.0f) * BB_CTRL_OUT_VOLT_LOOP_W_CUT * HW_BUCK_BOOST_OUTPUT_CAP_VALUE)
#define BB_CTRL_OUT_VOLT_LOOP_KI \
    (BB_CTRL_OUT_VOLT_LOOP_W_CUT * BB_CTRL_OUT_VOLT_LOOP_KP / tanf(BB_CTRL_OUT_VOLT_LOOP_PM * M_PI / 180.0f))
...
#define BB_CTRL_IN_VOLT_LMT_LOOP_KP \
    (sinf(BB_CTRL_IN_VOLT_LMT_LOOP_PM * M_PI / 180.0f) * BB_CTRL_IN_VOLT_LMT_LOOP_W_CUT * HW_BUCK_BOOST_INPUT_CAP_VALUE)
#define BB_CTRL_IN_VOLT_LMT_LOOP_KI \
    (BB_CTRL_IN_VOLT_LMT_LOOP_W_CUT * BB_CTRL_IN_VOLT_LMT_LOOP_KP / tanf(BB_CTRL_IN_VOLT_LMT_LOOP_PM * M_PI / 180.0f))
...
#define BB_CTRL_IN_CURR_LOOP_KP \
    (sinf(BB_CTRL_IN_CURR_LOOP_PM * M_PI / 180.0f) * BB_CTRL_IN_CURR_LOOP_W_CUT * HW_BUCK_BOOST_IND_VALUE)
#define BB_CTRL_IN_CURR_LOOP_KI \
    (BB_CTRL_IN_CURR_LOOP_W_CUT * BB_CTRL_IN_CURR_LOOP_KP / tanf(BB_CTRL_IN_CURR_LOOP_PM * M_PI / 180.0f))
...
#define BB_CTRL_OUT_CURR_LOOP_KP \
    (sinf(BB_CTRL_OUT_CURR_LOOP_PM * M_PI / 180.0f) * BB_CTRL_OUT_CURR_LOOP_W_CUT * HW_BUCK_BOOST_IND_VALUE)
#define BB_CTRL_OUT_CURR_LOOP_KI \
    (BB_CTRL_OUT_CURR_LOOP_W_CUT * BB_CTRL_OUT_CURR_LOOP_KP / tanf(BB_CTRL_OUT_CURR_LOOP_PM * M_PI / 180.0f))
...
#define BB_CTRL_IND_CURR_LOOP_KP \
    (sinf(BB_CTRL_IND_CURR_LOOP_PM * M_PI / 180.0f) * BB_CTRL_IND_CURR_LOOP_W_CUT * HW_BUCK_BOOST_IND_VALUE)
#define BB_CTRL_IND_CURR_LOOP_KI \
    (BB_CTRL_IND_CURR_LOOP_W_CUT * BB_CTRL_IND_CURR_LOOP_KP / tanf(BB_CTRL_IND_CURR_LOOP_PM * M_PI / 180.0f))
