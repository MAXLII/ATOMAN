...
#define INV_CTRL_NOMINAL_LOAD_OHM   ((INV_CTRL_NOMINAL_RMS_V * INV_CTRL_NOMINAL_RMS_V) / INV_CTRL_RATED_POWER_W)

#define INV_CTRL_INNER_LOOP_BANDWIDTH_HZ    (6000.0f)
...
#define INV_CTRL_INNER_LOOP_SQRT_TERM                                                                              \
    ((2.0f * INV_CTRL_FILTER_IND_RES_OHM * HW_AC_SIDE_CAP_VALUE * INV_CTRL_NOMINAL_LOAD_OHM                        \
      * ((INV_CTRL_FILTER_IND_RES_OHM * HW_AC_SIDE_CAP_VALUE * INV_CTRL_NOMINAL_LOAD_OHM) + HW_AC_SIDE_IND_VALUE)) \
     + (HW_AC_SIDE_IND_VALUE * HW_AC_SIDE_IND_VALUE                                                                \
        * (2.0f                                                                                                    \
           + (HW_AC_SIDE_CAP_VALUE * HW_AC_SIDE_CAP_VALUE * INV_CTRL_NOMINAL_LOAD_OHM * INV_CTRL_NOMINAL_LOAD_OHM  \
              * INV_CTRL_INNER_LOOP_BANDWIDTH_RADPS * INV_CTRL_INNER_LOOP_BANDWIDTH_RADPS))))
#define INV_CTRL_INNER_LOOP_K                                                                                 \
    ((HW_AC_SIDE_IND_VALUE + (INV_CTRL_FILTER_IND_RES_OHM * HW_AC_SIDE_CAP_VALUE * INV_CTRL_NOMINAL_LOAD_OHM) \
      + sqrtf(INV_CTRL_INNER_LOOP_SQRT_TERM))                                                                 \
     / (HW_AC_SIDE_CAP_VALUE * INV_CTRL_NOMINAL_LOAD_OHM))

#define INV_CTRL_INDUCTOR_LOOP_BANDWIDTH_HZ    (2000.0f)
#define INV_CTRL_INDUCTOR_LOOP_BANDWIDTH_RADPS (M_2PI * INV_CTRL_INDUCTOR_LOOP_BANDWIDTH_HZ)
#define INV_CTRL_INDUCTOR_LOOP_KP \
    (HW_AC_SIDE_IND_VALUE * INV_CTRL_INDUCTOR_LOOP_BANDWIDTH_RADPS / INV_CTRL_INNER_LOOP_K)
#define INV_CTRL_INDUCTOR_LOOP_KI \
    (INV_CTRL_FILTER_IND_RES_OHM * INV_CTRL_INDUCTOR_LOOP_BANDWIDTH_RADPS / INV_CTRL_INNER_LOOP_K)
#define INV_CTRL_INDUCTOR_LOOP_OUT_MAX_A (6.0f)
#define INV_CTRL_INDUCTOR_LOOP_OUT_MIN_A (-6.0f)

#define INV_CTRL_VOLT_LOOP_BANDWIDTH_HZ    (600.0f)
#define INV_CTRL_VOLT_LOOP_BANDWIDTH_RADPS (M_2PI * INV_CTRL_VOLT_LOOP_BANDWIDTH_HZ)
#define INV_CTRL_VOLT_LOOP_INTEGRATOR_HZ   (40.0f)
#define INV_CTRL_VOLT_LOOP_KP              (HW_AC_SIDE_CAP_VALUE * INV_CTRL_VOLT_LOOP_BANDWIDTH_RADPS)
#define INV_CTRL_VOLT_LOOP_KI              (INV_CTRL_VOLT_LOOP_KP * M_2PI * INV_CTRL_VOLT_LOOP_INTEGRATOR_HZ)
#define INV_CTRL_VOLT_LOOP_OUT_MAX_A       (25.0f)
#define INV_CTRL_VOLT_LOOP_OUT_MIN_A       (-25.0f)
