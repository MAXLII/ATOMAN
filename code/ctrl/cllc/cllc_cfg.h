...
#define CLLC_CTRL_LOAD_RESISTANCE_OHM(voltage_v, power_w)         (((voltage_v) * (voltage_v)) / (power_w))
#define CLLC_CTRL_OUTPUT_TIME_CONSTANT_S(load_ohm, capacitance_f) (0.5f * (load_ohm) * (capacitance_f))
#define CLLC_CTRL_OUTPUT_POLE_HZ(time_constant_s)                 (1.0f / (M_2PI * (time_constant_s)))
#define CLLC_CTRL_PI_KP_FIRST_ORDER(control_gain, time_constant_s, crossover_hz, zero_hz)                        \
    (sqrtf(1.0f + ((M_2PI * (crossover_hz) * (time_constant_s)) * (M_2PI * (crossover_hz) * (time_constant_s)))) \
     / ((control_gain) * sqrtf(1.0f + (((zero_hz) / (crossover_hz)) * ((zero_hz) / (crossover_hz))))))
#define CLLC_CTRL_PI_KI_FROM_ZERO(kp, zero_hz)  (M_2PI * (zero_hz) * (kp))
#define CLLC_CTRL_PI_KI_STEP(ki, sample_time_s) ((ki) * (sample_time_s))
...
#define CLLC_CTRL_FORWARD_LOAD_OHM \
    CLLC_CTRL_LOAD_RESISTANCE_OHM(CLLC_CTRL_FORWARD_DESIGN_VOLTAGE_V, CLLC_CTRL_FORWARD_DESIGN_POWER_W)
#define CLLC_CTRL_FORWARD_OUTPUT_TAU_S \
    CLLC_CTRL_OUTPUT_TIME_CONSTANT_S(CLLC_CTRL_FORWARD_LOAD_OHM, CLLC_HW_BATTERY_OUTPUT_CAP_F)
#define CLLC_CTRL_FORWARD_ZERO_HZ              CLLC_CTRL_OUTPUT_POLE_HZ(CLLC_CTRL_FORWARD_OUTPUT_TAU_S)
#define CLLC_CTRL_FORWARD_CURRENT_GAIN_A_PER_U (CLLC_CTRL_FORWARD_CONTROL_GAIN_V_PER_U / CLLC_CTRL_FORWARD_LOAD_OHM)
...
#define CLLC_CTRL_FORWARD_VOLTAGE_KI CLLC_CTRL_PI_KI_FROM_ZERO(CLLC_CTRL_FORWARD_VOLTAGE_KP, CLLC_CTRL_FORWARD_ZERO_HZ)
#define CLLC_CTRL_FORWARD_CURRENT_KP                                    \
    CLLC_CTRL_PI_KP_FIRST_ORDER(CLLC_CTRL_FORWARD_CURRENT_GAIN_A_PER_U, \
                                ...
                                CLLC_CTRL_FORWARD_ZERO_HZ)
#define CLLC_CTRL_FORWARD_CURRENT_KI CLLC_CTRL_PI_KI_FROM_ZERO(CLLC_CTRL_FORWARD_CURRENT_KP, CLLC_CTRL_FORWARD_ZERO_HZ)
...
#define CLLC_CTRL_FORWARD_PR_W0_RAD_PER_S     (M_2PI * CLLC_CTRL_FORWARD_PR_FREQ_HZ)
#define CLLC_CTRL_FORWARD_PR_WC_RAD_PER_S     (M_2PI * CLLC_CTRL_FORWARD_PR_BANDWIDTH_HZ)
...
#define CLLC_CTRL_FORWARD_PR_KR       (CLLC_CTRL_FORWARD_PR_TARGET_LOOP_GAIN / CLLC_CTRL_FORWARD_PR_PLANT_MAG_V_PER_U)
...
#define CLLC_CTRL_REVERSE_LOAD_OHM \
    CLLC_CTRL_LOAD_RESISTANCE_OHM(CLLC_CTRL_REVERSE_DESIGN_VOLTAGE_V, CLLC_CTRL_REVERSE_DESIGN_POWER_W)
#define CLLC_CTRL_REVERSE_OUTPUT_TAU_S \
    CLLC_CTRL_OUTPUT_TIME_CONSTANT_S(CLLC_CTRL_REVERSE_LOAD_OHM, CLLC_HW_BUS_OUTPUT_CAP_F)
#define CLLC_CTRL_REVERSE_ZERO_HZ CLLC_CTRL_OUTPUT_POLE_HZ(CLLC_CTRL_REVERSE_OUTPUT_TAU_S)
...
#define CLLC_CTRL_REVERSE_VOLTAGE_KI CLLC_CTRL_PI_KI_FROM_ZERO(CLLC_CTRL_REVERSE_VOLTAGE_KP, CLLC_CTRL_REVERSE_ZERO_HZ)
