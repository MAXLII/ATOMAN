...
#define CLLC_HW_FORWARD_BUS_REF_V(v_battery_ref_v) \
    CLLC_HW_MAX_FLOAT(CLLC_HW_FORWARD_BUS_MIN_V,   \
                      (CLLC_HW_FORWARD_BUS_GAIN * (v_battery_ref_v)) + CLLC_HW_FORWARD_BUS_OFFSET_V)
...
#define CLLC_HW_PRIMARY_RESONANT_FREQ_HZ \
    (1.0f / (CLLC_HW_TWO_PI * sqrtf(CLLC_HW_PRIMARY_RESONANT_IND_H * CLLC_HW_PRIMARY_RESONANT_CAP_F)))
