...
uint8_t buck_cfg_set_pwr_lmt(float pwr_lmt)
{
    ...
    code             = buck_cfg_float_to_code(pwr_lmt, BUCK_CTRL_IN_PWR_LMT_MAX_W, BUCK_CTRL_IN_PWR_LMT_CODE_MAX);
...
uint8_t buck_cfg_set_in_curr_lmt(float in_curr_lmt)
{
    ...
    code = buck_cfg_float_to_bipolar_code(in_curr_lmt, BUCK_CTRL_IN_CURR_LMT_MAX_A, BUCK_CTRL_IN_CURR_LMT_CODE_MAX);
...
uint8_t buck_cfg_set_out_curr_lmt(float out_curr_lmt)
{
    ...
    code = buck_cfg_float_to_bipolar_code(out_curr_lmt, BUCK_CTRL_OUT_CURR_LMT_MAX_A, BUCK_CTRL_OUT_CURR_LMT_CODE_MAX);
