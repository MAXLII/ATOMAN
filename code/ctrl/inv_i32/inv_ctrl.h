...
#define INV_CTRL_VOLT_LOOP_KP                                                                          \
     ...
     * (sqrtf((2.0f * HW_AC_SIDE_IND_VALUE * HW_AC_SIDE_IND_VALUE * INV_CTRL_VOLT_LOOP_BANDWIDTH_RADPS \
               * INV_CTRL_VOLT_LOOP_BANDWIDTH_RADPS)                                                   \
...
#define INV_CTRL_VOLT_LOOP_KI       (INV_CTRL_VOLT_LOOP_KI_RATIO * INV_CTRL_VOLT_LOOP_KP * M_2PI * INV_CTRL_NOMINAL_FREQ_HZ)

#define INV_CTRL_K2_CURR_SHIFT       (16U)
#define INV_CTRL_K2_CURR_K           ((int32_t)(1L << INV_CTRL_K2_CURR_SHIFT))
#define INV_CTRL_VOLT_PI_GAIN_K      ((float)INV_CTRL_K2_CURR_K * INV_CTRL_IND_CURR_CODE_PER_A / INV_CTRL_AC_VOLT_CODE_PER_V)
...
#define INV_CTRL_VOLT_LOOP_OUT_MAX_I32 \
    ((int32_t)((INV_CTRL_VOLT_LOOP_OUT_MAX_A * INV_CTRL_IND_CURR_CODE_PER_A * (float)INV_CTRL_K2_CURR_K) + 0.5f))
...
#define INV_CTRL_HARMONIC_OUT_MAX_I32 ((int32_t)((INV_CTRL_HARMONIC_OUT_MAX_A * INV_CTRL_IND_CURR_CODE_PER_A) + 0.5f))
#define INV_CTRL_HARMONIC_OUT_MIN_I32 (-INV_CTRL_HARMONIC_OUT_MAX_I32)

#define INV_CTRL_INNER_GAIN_I32                                                                  \
    ((int32_t)((INV_CTRL_INNER_LOOP_K * (float)INV_CTRL_PWM_RELOAD * INV_CTRL_AC_VOLT_CODE_PER_V \
