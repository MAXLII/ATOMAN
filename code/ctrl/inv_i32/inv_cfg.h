...
#define INV_CTRL_FREQ_TO_Q16(value) ((uint32_t)(((value) * (float)INV_CTRL_FREQ_Q_ONE) + 0.5f))
#define INV_CTRL_RMS_TO_PEAK_CODE_Q16(value) \
    ((int32_t)((((value) * INV_CTRL_SQRT2 * INV_CTRL_AC_VOLT_CODE_PER_V) * (float)INV_CTRL_REF_Q_ONE) + 0.5f))
#define INV_CTRL_RMS_SLEW_TO_PEAK_CODE_Q16_PER_S(value) \
    ((uint32_t)((((value) * INV_CTRL_SQRT2 * INV_CTRL_AC_VOLT_CODE_PER_V) * (float)INV_CTRL_REF_Q_ONE) + 0.5f))
