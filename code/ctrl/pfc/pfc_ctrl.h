 ...
 *          - Define PFC controller HAL measurements, references, and runtime control structures
 *          - Expose PFC preparation, stepping, and protection-check APIs
 *          - Provide the public interface between PFC control logic and platform HAL callbacks
 *
 *          Design notes:
 *          - C11 compatible
