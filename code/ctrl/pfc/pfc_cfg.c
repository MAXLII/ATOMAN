 ...
 *          - Maintain active/building PFC setpoint buffers with versioned publishing
 *          - Provide setters for run permission, bus-voltage reference, current limits, and mode flags
 *          - Keep staged PFC configuration updates separate from active control-loop consumption
 *
 *          Design notes:
 *          - C11 compatible
