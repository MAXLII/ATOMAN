...
/**
 * @file    plecs_port.h
 * @brief   PLECS PFC port definition module.
 * @details
 *          This file is part of the base project.
 *
 *          Module responsibilities:
 *          - Define PFC PLECS input signal indexes
 *          - Define PFC PLECS output signal indexes
...
#ifndef PLECS_PFC_PORT_H
#define PLECS_PFC_PORT_H
